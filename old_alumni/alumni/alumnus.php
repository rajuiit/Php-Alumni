    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="alumnus.php">Alumni</a>
          </li>
          <li class="nav-item">
       ...
       while($res=mysqli_fetch_array($search_result)){
        ...
        ?>
              ...
              <tbody>
                ...
                <td><button class="btn btn-success"><a href="alumni_info_login.php" class="text-white">View Details</a></button></td>
              </tbody>
              <?php
                }
              ?>
