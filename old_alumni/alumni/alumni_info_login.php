...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand text-brand" href="index.php">Alumni<?php echo " ";?><span class="color-b">(CSE-DIU)</span></a>
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="alumnus.php">Alumnui</a>
          </li>
          <li class="nav-item">
  ...
  <section class="section-services section-t8"  id="logreg">
    <div class="container-fluid">
      <div class="row jumbotron">
        ...
        <div class="col-md-4">
          <h4 style="margin-top:80px;"><b>Alumni Login to Access Full Information.</b></h4>
        </div>
        <div class="col-md-4">
                ...
                <div class="col-md-10">
                  <form action="alumni-login.php" method="POST">
                    ...
                    <div class="form-row">
                      ...
                      <a class="btn-success btn" href="reset-password.php" style="margin-left:20px;">Forget Password</a>
                    </div>
                  </form>
                </div>
              </div>
